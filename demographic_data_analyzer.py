...
def calculate_demographic_data(print_data=True):
    ...
    if print_data:
        ...
        print(f"Bachelors degrees: {percentage_bachelors}%")
        print(f"Percentage of salary with Higher education  >50K: {higher_education_rich}%")
        print(f" Percentage of salary without Higher education >50K: {lower_education_rich}%")
